...
const comics = [
  ...
  },
  {
    ...
    thumb: "https://www.fumetto-online.it/images/fumetti/PANINI%20DC/panini-dc-batman-56-batman-56-86678000560.jpg",
    price: "$3.99",
    series: "Batman",
...
function App() {
  ...
  return (
    <>
      ...
      <AppFooter
        linksColumnOne={linksColumnOne}
        linksColumnTwo={linksColumnTwo}
        linksColumnThree={linksColumnThree}
      />
    </>
  )
}
